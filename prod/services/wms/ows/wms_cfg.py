        ...
        "products": [
            {
                ...
                "abstract": "Mangrove canopy cover version 1, 25 metre, 100km tile,"
                            ...
                            "Data is only visible at higher resolutions;"
                            "when zoomed-out the available area will be displayed as a shaded region."
                            "The mangrove canopy cover product provides valuable information"
                            "about the extent and canopy density of mangroves for each year"
                            "between 1987 and 2016 for the entire Australian coastline."
                            "The canopy cover classes are"
                            "20-50% (pale green), 50-80% (mid green), 80-100% (dark green)."
                            "The product consists of  a sequence (one per year) of 25 meter resolution maps"
                            "that are generated by analysing the Landsat fractional cover"
                            "(https://doi.org/10.6084/m9.figshare.94250.v1)"
                            "developed by the Joint Remote Sensing Research Program"
                            "and the Global Mangrove Watch layers (https://doi.org/10.1071/MF13177)"
                            "developed by the Japanese Aerospace Exploration Agency."
        ...
        "products": [
            ...
            },
            {
                ...
                "abstract": "Water Observations from Space - Filtered Statistics is a set of statistical summaries of the water observations"
                            ...
                            "This layer is Filtered Water Summary: A simplified version of the Water Summary,"
