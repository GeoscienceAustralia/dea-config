...
s2c_layer = {
    "name": "ga_s2cm_ard_3",
    "title": "DEA Surface Reflectance (Sentinel-2C MSI)",
    "abstract": """Geoscience Australia Sentinel-2C MSI Analysis Ready Data Collection 3
...
It contains two sub-products that provide corrections or attribution information:
   ...
   * DEA Surface Reflectance NBART (Sentinel-2C MSI) https://knowledge.dea.ga.gov.au/data/product/dea-surface-reflectance-nbart-sentinel-2c-msi/
   * DEA Surface Reflectance OA (Sentinel-2C MSI) https://knowledge.dea.ga.gov.au/data/product/dea-surface-reflectance-oa-sentinel-2c-msi/

The resolution is a 10/20/60 m grid based on the ESA Level 1C archive.

Full product description: https://knowledge.dea.ga.gov.au/data/product/dea-surface-reflectance-sentinel-2c-msi/

For service status information, see https://status.dea.ga.gov.au""",
    "product_name": "ga_s2cm_ard_3",
...
This product takes Sentinel-2 imagery captured over the Australian continent and corrects for inconsistencies across land and coastal fringes. The result is accurate and standardised surface reflectance data, which is instrumental in identifying and quantifying environmental change.

The imagery is captured using the Multispectral Instrument (MSI) sensor aboard Sentinel-2A, Sentinel-2B and Sentinel-2C.
...
Full Sentinel-2C product description: https://knowledge.dea.ga.gov.au/data/product/dea-surface-reflectance-sentinel-2c-msi/

For service status information, see https://status.dea.ga.gov.au""",
    "multi_product": True,
    "product_names": ["ga_s2am_ard_3", "ga_s2bm_ard_3", "ga_s2cm_ard_3"],
    "bands": bands_sentinel2,
    "resource_limits": reslim_for_sentinel2,
    "dynamic": True,
    "native_crs": "EPSG:3577",
