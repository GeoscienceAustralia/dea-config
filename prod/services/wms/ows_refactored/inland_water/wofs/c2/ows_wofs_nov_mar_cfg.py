...
wet_layer = {
    "title": "DEA November-March Wet Observation Statistics (Landsat, DEPRECATED)",
...
clear_layer = {
    "title": "DEA November-March Clear Observation Statistics (Landsat, DEPRECATED)",
...
statistics_layer = {
    "title": "DEA November-March Seasonal Water Observations (Landsat, DEPRECATED)",
