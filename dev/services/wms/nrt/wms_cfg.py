        ...
        "products": [
            {
                ...
                "type": "ard",
                # Included as a keyword  for the layer
                "variant": "S2-MSI-combined",
                # The WMS name for the layer
                "name": "s2_nrt_granule_nbar_t",
                # Merged layer combining both Sentinel-2A and 2B.
                "multi_product": True,
        ...
        "products": [
            {
                ...
                "styles": [
                    ...
                    # Examples of non-linear heat-mapped styles.
                    {
                        ...
                        "abstract": "Normalised Difference Vegetation Index - a derived index that correlates well with the existence of vegetation",
                        "heat_mapped": True,
                        "index_function": lambda data: (data["nbart_nir"] - data["nbart_red"]) / (
                    ...
                    },
                    {
                        ...
                        "abstract": "Normalised Difference Buildup Index - a derived index that correlates with the existence of urbanisation",
                        "heat_mapped": True,
                        "index_function": lambda data: (data["nbart_swir_2"] - data["nbart_nir"]) / (
                                    data["nbart_swir_2"] + data["nbart_nir"]),
