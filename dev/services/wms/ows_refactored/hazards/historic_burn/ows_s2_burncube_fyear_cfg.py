...
layers = {
    "title": "DEA BurnCube Historic Burnt Area Financial Year (Sentinel-2)",
    "name": "ga_s2_ard_bc_fyear_3",
    "abstract": """BurnCube Historic Burnt Area, Financial Year, 30m, 0.0.0 (Sentinel-2, Collection 3)
...
BurnCube Historic Burnt Area is styled in three layers; “Moderate Burn”, “Severe Burn”, and “Combined Burn: Moderate and Severe”. Each layer identifies areas that have shown characteristics of being burnt during that financial year.
...
For service status information, see https://status.dea.ga.gov.au""",
    "product_name": "ga_s2_ard_bc_fyear_3",
