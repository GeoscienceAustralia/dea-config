category_layers = {
    ...
    "layers": [
        ...
        {
            "include": "ows_refactored.hazards.dea_fmc.ows_fmc_combined_cfg.layer_s2ab",
            "type": "python",
        },
        {
            "include": "ows_refactored.hazards.dea_fmc.ows_fmc_combined_cfg.layer_combined_mosaic",
            "type": "python",
        },
        {
