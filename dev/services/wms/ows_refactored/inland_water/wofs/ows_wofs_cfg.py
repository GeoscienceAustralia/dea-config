...
layers = {
    ...
    "layers": [
        ...
        {
            "include": "ows_refactored.inland_water.wofs.ows_wofs_summary_cfg.c3_statistics_layer",
            "type": "python",
        },
        {
        ...
        {
            "include": "ows_refactored.inland_water.wofs.ows_wofs_summary_cfg.c3_layers",
            "type": "python",
        },
    ],
}
