...
The DEA Water Observations Annual Statistic is a set of calendar year statistical summaries of the DEA Water Observation product that combines satellite observations, that occur within each calendar year from 1986 to present, into summary products that help the understanding of surface water across Australia. The layers available are: the count of clear observations; the count of wet observations; and the percentage of wet observations that were observed over the specified time period in the landscape.
