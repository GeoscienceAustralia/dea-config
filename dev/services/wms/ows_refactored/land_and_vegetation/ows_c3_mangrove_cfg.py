    ...
    "layers": [
        {
            ...
            "abstract": """Mangrove Canopy Cover 30m 2.0.2 (Landsat, Collection 3)

Mangrove canopy cover version 2.0.2, 30 metre. Data is only visible at higher resolutions; when zoomed-out the available area will be displayed as a shaded region.
