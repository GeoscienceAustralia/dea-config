...
style_ls_mndwi = {
    ...
    "index_function": {
        "function": "datacube_ows.band_utils.norm_diff",
        "mapped_bands": True,
        "kwargs": {"band1": "nbart_green", "band2": "nbart_swir1"},
    },
    "needed_bands": ["nbart_green", "nbart_swir1"],
    "color_ramp": [
        {"value": -0.1, "color": "#f7fbff", "alpha": 0.0},
...
style_ls_pure_swir1 = {
    ...
    "components": {
        "red": {"nbart_swir1": 1.0},
        "green": {"nbart_swir1": 1.0},
        "blue": {"nbart_swir1": 1.0},
    },
    "scale_range": [0.0, 3000.0],
}
style_ls_pure_swir2 = {
    ...
    "components": {
        "red": {"nbart_swir2": 1.0},
        "green": {"nbart_swir2": 1.0},
        "blue": {"nbart_swir2": 1.0},
    },
    "scale_range": [0.0, 3000.0],
}
