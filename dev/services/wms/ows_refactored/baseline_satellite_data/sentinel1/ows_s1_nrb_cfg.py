...
from ows_refactored.baseline_satellite_data.sentinel1.style_s1_nrb_cfg import (
    styles_s1_nrb_vh_list, styles_s1_nrb_vv_list, styles_s1_nrb_vvvh_list)
...
iw_vh_0_layer = {
    "name": "ga_s1_nrb_iw_vh_0",
    "title": "DE Normalised Radar Backscatter (Sentinel-1 IW, VH)",
    "abstract": "Experimental Sentinel-1 backscatter data (VH)",
    "product_name": "ga_s1_nrb_iw_vh_0",
    "native_crs": "EPSG:3577",
    "native_resolution": [20, -20],
    "bands": bands_sentinel1_nrb,
    "resource_limits": reslim_for_sentinel1,
